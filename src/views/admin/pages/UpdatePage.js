...
const UpdatePage = () => {
    ...
    const editPage = async (formValue) => {
        ...
        console.log("Edit page form data => ", data);
        const response = await ApiService.putAPIWithAccessToken(api.UpdatePage + `${decode(id)}`, data);
    ...
    const getPageDetails = async (api) => {
        setLoading(true);
        const response = await ApiService.getAPIWithAccessToken(api);
        console.log("Page details => ", response.data.body);
        if (response.data.headers.success === 1) {
    ...
    useEffect(() => {
        getPageDetails(api.GetPageDetails + `${decode(id)}`);
        ...
        <>
            ...
            <div className="news-section">
                ...
                <div className="news-create-form" >
                    <Formik initialValues={initialValue} validateOnChange={true} validationSchema={validateSchema} onSubmit={editPage} enableReinitialize>
                        <Form>
                            <div className="row">
